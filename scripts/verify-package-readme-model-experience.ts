...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/vision/vision': { kind: 'indirect', reason: 'The vision seam returns text the image-admission consumer renders; it registers no prompt or schema of its own.' },
  'packages/vision/vision-http': { kind: 'indirect', reason: 'The provider returns a text description the image-admission consumer renders; it registers no prompt or schema of its own.' },
  'packages/vision/vision-attachment': { kind: 'indirect', reason: 'The consumer rewrites image parts to description text through the vision seam; it registers no prompt or schema of its own.' },
  'packages/team-tasks/team-tasks': { kind: 'indirect', reason: 'The board store is model-agnostic; the AI processing consumer owns any model-visible projection of task content.' },
  'packages/team-tasks/team-tasks-json': { kind: 'indirect', reason: 'The persistence provider serves the model-agnostic board store; it owns no model-facing projection.' },
  'packages/team-tasks/team-tasks-ai': { kind: 'indirect', reason: 'The consumer runs a dispatched turn whose prompt and report are model-facing; user sessions are untouched.' },
  ...
  'packages/client/ui-team-tasks': { kind: 'none', reason: 'Browser-side board over durable task data; the host AI-processing consumer owns any model-visible projection of task content.' },
