...
/** Dutch strings (same keys as en). */
export const nl: { [Key in keyof typeof en]: string } = {
  nav: 'Modellen',
  title: 'Modellen',
  intro: 'Voer uw API-sleutels in om modellen van de volgende aanbieders te gebruiken.',
  edit: 'Bewerken',
  editProvider: '{provider} bewerken',
  remove: 'Verwijderen',
  removeProvider: '{provider} verwijderen',
  deleteTitle: '{provider} verwijderen?',
  deleteDescription: 'Het verwijderen van {provider} verwijdert de configuratie. Eventuele inloggegevens worden elders beheerd en blijven bewaard.',
  deleteDescriptionWithCredential: 'Het verwijderen van {provider} verwijdert de configuratie en de opgeslagen API-sleutel.',
  ...
  readOnly: 'Het instellingendocument is alleen-lezen in deze installatie.',
  loadFailed: 'Laden van het aanbiedersoverzicht mislukt',
  conflict: 'Iemand anders heeft deze instellingen gewijzigd terwijl deze kaart open stond. Sluit en heropen om de huidige waarden te bewerken.',
  ...
  keyEnvLocked: 'Geleverd door de startomgeving (alleen-lezen)',
  customized: 'Aangepaste instellingen',
  baseUrl: 'Basis-URL',
  baseUrlDefault: 'Standaard aanbieder',
  models: 'Modellen',
  modelsInherited: 'Gebruikt de adapterstandaarden',
  modelsCustomized: 'Aangepaste modelcatalogus',
  resetModels: 'Standaardwaarden herstellen',
  model: 'Model',
  modelId: 'Model-ID',
  modelName: 'Weergavenaam',
  modelNamePlaceholder: 'Gebruikt het model-ID indien leeg',
  contextWindow: 'Contextvenster',
  contextWindowPlaceholder: 'Gebruikt de standaardwaarde van de aanbieder',
  maxTokens: 'Max. uitvoertokens',
  maxTokensPlaceholder: 'Gebruikt de standaardwaarde van de aanbieder',
  modelAdvanced: 'Capaciteiten',
  addModel: 'Model toevoegen',
  removeModel: 'Model verwijderen',
  modelsEmpty: 'Er worden geen modellen getoond in de selector. Niet-vermelde ID\'s kunnen nog steeds direct worden verzonden.',
  keyBlank: 'Voer de API-sleutel in, of laat het veld leeg om de opgeslagen sleutel te behouden.',
  keyBlankNew: 'Voer de API-sleutel in, of laat het veld leeg als deze aanbieder op een andere manier verifieert.',
  keyIllegalCharacters: 'Deze API-sleutel heeft geen geldig formaat. Controleer deze alstublieft.',
  modelIdRequired: 'Model-ID is verplicht.',
  ...
  modelMaxTokensInvalid: 'Max. uitvoertokens moet een positief getal zijn, zoals 8192, 64K of 1M.',
  advancedHint: 'Andere velden staan in settings.yaml; bewerk die sectie direct.',
  modelCapacityInvalid: 'Een capaciteit moet een getal zijn, optioneel gevolgd door K of M.',
  modelDuplicate: 'Elk model-ID mag één keer voorkomen.',
  modelContextWindow: 'Contextvenster',
  modelMaxTokens: 'Max. uitvoertokens',
  fetchModels: 'Beschikbare modellen ophalen',
  fetching: 'Aanbieder raadplegen\u2026',
  fetchNeedsBaseUrl: 'Voer eerst de basis-URL in en haal daarna modellen op.',
  fetchEmpty: 'De aanbieder vermeldde geen modellen. Voeg ze handmatig toe.',
  fetchTitle: 'Kies modellen om toe te voegen',
  fetchDescription: 'Dit zijn de modellen die deze aanbieder beschikbaar heeft. Kies welke u wilt toevoegen.',
  fetchAdopt: 'Geselecteerde toevoegen',
  customAdd: 'Aangepaste aanbieder toevoegen',
  customTitle: 'Aangepaste aanbieder',
  customTag: 'Aangepast',
  customRoute: 'Aanbieders-ID',
  customRouteHint: 'Identificatie in kleine letters, beginnend met een letter, die deze aanbieder uniek aanduidt in verzoeken en als referentie.',
  customRouteInvalid: 'Begin met een kleine letter; daarna kleine letters, cijfers en koppeltekens.',
  customRouteTaken: 'Een aanbieder gebruikt dit ID al.',
  customDisplayName: 'Weergavenaam',
  customApi: 'API-protocol',
  customApiUnset: 'Niet geselecteerd',
  customNeedsBaseUrl: 'Een aangepaste aanbieder heeft een basis-URL nodig.',
  customNeedsModels: 'Een aangepaste aanbieder heeft minimaal één model nodig.',
  create: 'Aanbieder aanmaken',
  creating: 'Aanmaken\u2026',
  welcomeTitle: WELCOME_NOTICE_COPY.en.title,
  welcomeBody: WELCOME_NOTICE_COPY.en.body,
  welcomeContinue: WELCOME_NOTICE_COPY.en.continueLabel,
  ...
  onboardingDescription: 'Configureer de officiële DeepSeek-aanbieder om te beginnen met bouwen.',
