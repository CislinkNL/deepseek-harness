...
import { en, nl, zh, type CommonKey } from '../locales/index.ts'
import {
  en as settingsEn, nl as settingsNl, zh as settingsZh, type SettingsLocaleKey,
...
export function apply(ctx: ClientContext): void {
  ...
  locale.register(COMMON_NS, { zh, en, nl })
  locale.register(SETTINGS_NS, { zh: settingsZh, en: settingsEn, nl: settingsNl })
